#!/usr/bin/env python3
"""
MediVote Working Startup Script
Final working version with proper timing
"""
...
class MediVoteWorkingRunner:
    ...
    def start_service(self, name, command):
        """Service starter with proper timing"""
        ...
        try:
            ...
            time.sleep(12)  # Give more time to start
            
            # Don't check process status - just assume it's working
