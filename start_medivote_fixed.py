#!/usr/bin/env python3
"""
MediVote Fixed Startup Script
Improved version with better health check timing
"""
...
class MediVoteFixedRunner:
    ...
    def start_service(self, name, command, test_url=None, test_timeout=90):
        """Generic service starter with improved testing"""
        ...
        try:
            ...
            time.sleep(15)  # Give more time to start
    ...
    def start_all_services(self):
        """Start all services with improved timing"""
        services = [
